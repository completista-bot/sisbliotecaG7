...
<?php $this->load->view('includes/header');?>
    ...
    <br>
        <form method="post" action="<?php echo site_url('CrudController/update')?>/<?php echo $row->id; ?>">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1"><i class="fas fa-at"></i>Correo</label>
                <input type="email" class="form-control" name="bio" value="<?php echo $row->bio; ?>" aria-describedby="emailHelp" placeholder="Enter bio">
